...
type Account struct {
	...
	Username    string     `valid:"required~Username is required" gorm:"type:text;not null;column:username" json:"username"`
	Hint        string     `valid:"-" gorm:"type:text;column:hint" json:"hint,omitempty"`
